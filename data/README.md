...
- `artemis-backup.json` respalda sorteos, adjudicados destacados y, para cada período, la tabla de adjudicados junto con las fechas y los tres números de premio publicados por Artemis.
